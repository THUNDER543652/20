        ...
        <div className="mx-auto max-w-[1280px] px-5 py-8 sm:px-6 lg:py-9">
          <div className="flex flex-col items-center text-center">
            <Link href="/" className="inline-flex items-center gap-2">
              <AppLogo size={28} />
              <span className="text-sm font-bold text-foreground">Test<span className="text-primary">Appara</span></span>
            </Link>
        ...
        <div className="border-t border-border/80">
          <div className="mx-auto flex max-w-[1280px] flex-col items-center px-5 py-5 text-center sm:px-6">
            <nav aria-label="Footer navigation" className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[11px] font-medium text-foreground/60">
              ...
              <a href="https://13-lemon-phi.vercel.app/privacy" className="transition-colors hover:text-primary">Privacy</a>
              <span className="text-foreground/20" aria-hidden="true">|</span>
              <a href="https://13-lemon-phi.vercel.app/terms" className="transition-colors hover:text-primary">Terms</a>
              <span className="text-foreground/20" aria-hidden="true">|</span>
              <a href="https://13-lemon-phi.vercel.app/faq" className="transition-colors hover:text-primary">FAQ</a>
            </nav>
