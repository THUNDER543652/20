...
export default function DeviceTestSeriesPage() {
  ...
  const generatePdf = async () => {
    ...
    const logoData = await new Promise<string | null>((resolve) => {
      ...
      img.src = '/assests/images/testappara-icon.png';
    });
    ...
    const header = () => {
      ...
      if (logoData) pdf.addImage(logoData, 'PNG', 15, 6, 13, 13);
      pdf.setTextColor(...(accent as [number,number,number])); pdf.setFont('helvetica','bold'); pdf.setFontSize(20); pdf.text('TestAppara',32,15);
